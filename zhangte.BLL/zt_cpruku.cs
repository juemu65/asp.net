...
namespace zhangte.BLL
{
	...
	/// zt_cpruku
	/// </summary>
    public partial class zt_cpruku : System.Web.UI.Page
    {
        private readonly zhangte.DAL.zt_cpruku dal = new zhangte.DAL.zt_cpruku();
        ...
        public zt_cpruku(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["zt_cpruku"] != null)
                strifofpage = Session["zt_cpruku"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string 企业标识代码, string 产品名称, string 数量, string 入库原因, string 入库时间)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(zhangte.Model.zt_cpruku model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string 企业标识代码, string 产品名称, string 数量, string 入库原因, string 入库时间)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(zhangte.Model.zt_cpruku model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public zhangte.Model.zt_cpruku GetModelByCache(int Id)
        {

            string CacheKey = "zt_cprukuModel-" + Id;
            ...
            return (zhangte.Model.zt_cpruku)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<zhangte.Model.zt_cpruku> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<zhangte.Model.zt_cpruku> DataTableToList(DataTable dt)
        {
            List<zhangte.Model.zt_cpruku> modelList = new List<zhangte.Model.zt_cpruku>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                zhangte.Model.zt_cpruku model;
