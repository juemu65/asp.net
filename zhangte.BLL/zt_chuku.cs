...
namespace zhangte.BLL
{
	...
	/// zt_chuku
	/// </summary>
    public partial class zt_chuku : System.Web.UI.Page
    {
        private readonly zhangte.DAL.zt_chuku dal = new zhangte.DAL.zt_chuku();
        ...
        public zt_chuku(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["zt_chuku"] != null)
                strifofpage = Session["zt_chuku"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string 企业标识代码, string 产品名称, string 数量, string 出库原因, string 出库时间)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(zhangte.Model.zt_chuku model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string 企业标识代码, string 产品名称, string 数量, string 出库原因, string 出库时间)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(zhangte.Model.zt_chuku model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public zhangte.Model.zt_chuku GetModelByCache(int Id)
        {

            string CacheKey = "zt_chukuModel-" + Id;
            ...
            return (zhangte.Model.zt_chuku)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<zhangte.Model.zt_chuku> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<zhangte.Model.zt_chuku> DataTableToList(DataTable dt)
        {
            List<zhangte.Model.zt_chuku> modelList = new List<zhangte.Model.zt_chuku>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                zhangte.Model.zt_chuku model;
