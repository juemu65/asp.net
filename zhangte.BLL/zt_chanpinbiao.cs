...
namespace zhangte.BLL
{
	...
	/// zt_chanpinbiao
	/// </summary>
    public partial class zt_chanpinbiao : System.Web.UI.Page
    {
        private readonly zhangte.DAL.zt_chanpinbiao dal = new zhangte.DAL.zt_chanpinbiao();
        ...
        public zt_chanpinbiao(HttpContext context)
        {
            thiscontext = context;
        }
        ...
        {
            base.OnInit(e);
            if (Session["zt_chanpinbiao"] != null)
                strifofpage = Session["zt_chanpinbiao"].ToString();
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add( string 企业标识代码, string 产品名称, string 单价, string 数量, string 单位, string 图片, string 状态)
        {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add1(zhangte.Model.zt_chanpinbiao model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(string Id, string 企业标识代码, string 产品名称, string 单价, string 数量, string 单位, string 图片, string 状态)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update1(zhangte.Model.zt_chanpinbiao model)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public zhangte.Model.zt_chanpinbiao GetModelByCache(int Id)
        {

            string CacheKey = "zt_chanpinbiaoModel-" + Id;
            ...
            return (zhangte.Model.zt_chanpinbiao)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<zhangte.Model.zt_chanpinbiao> GetModelList(string strWhere)
        {
            if (strWhere != "" && strifofpage != "")
                strWhere = "(" + strWhere + " and " + strifofpage + ") ";
        ...
        /// 获得数据列表
        /// </summary>
        public List<zhangte.Model.zt_chanpinbiao> DataTableToList(DataTable dt)
        {
            List<zhangte.Model.zt_chanpinbiao> modelList = new List<zhangte.Model.zt_chanpinbiao>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                zhangte.Model.zt_chanpinbiao model;
